...
## [0.0.2](https://github.com/kachnitel/FrdEntityComponentsBundle/compare/0.0.1...0.0.2) (2026-03-27)

### Features

* Add editable basic fields from admin-bundle ([c42aea](https://github.com/kachnitel/FrdEntityComponentsBundle/commit/c42aeade9ed61f834f8f34fc82b13cd632e273ec))

##### DX

* Add generics to *Manager fields ([3b4295](https://github.com/kachnitel/FrdEntityComponentsBundle/commit/3b42959e5038c29c1173204dede766f7bc9d2cb5))

##### Fields

* Use options DTO wherever multiple options are used in fields ([d21368](https://github.com/kachnitel/FrdEntityComponentsBundle/commit/d2136815a89e6916faebdc2e283aac28653fa420))

### Bug Fixes

* Make file handler optional in AttachmentManager to allow compile in apps without one ([584310](https://github.com/kachnitel/FrdEntityComponentsBundle/commit/584310558bbb8a653ce22ecc95114e9607d2d3fa))
* Rather than an optional File handler interface, we remove the service if not implemented in compiler pass ([8fecbc](https://github.com/kachnitel/FrdEntityComponentsBundle/commit/8fecbca54b95724f39bdadf38ad56ba85cec36ca))
* Support entities and more in field/_display.html.twig ([b59b4d](https://github.com/kachnitel/FrdEntityComponentsBundle/commit/b59b4d61a92ed62bdfbccb24db0dae9780b5b9cb))
* Use array config attribute in Attachment/Tag/Comments components, avoid conflict with "options" attr for select ([8a321d](https://github.com/kachnitel/FrdEntityComponentsBundle/commit/8a321d70a2a2ad02ac4adf3bce4e76d17e26a0cf))

### Code Refactoring

* Reduce code duplication in Comment/Tag/Attachment manager components ([c15b18](https://github.com/kachnitel/FrdEntityComponentsBundle/commit/c15b189fc2770cf118ab5e1d64d07976c5e4b0ad))
* Respect SRP in extensions ([50cc6f](https://github.com/kachnitel/FrdEntityComponentsBundle/commit/50cc6fdcd006cae57da37d48ec04bc0e5d38e48d))
* Use DTO to configure "selectRelationship" ([ad963d](https://github.com/kachnitel/FrdEntityComponentsBundle/commit/ad963df20766e3fd6e8012c4962e1c025c0eb8c4))
...
* Add FieldTemplateRenderTest for parity with Admin bundle ([b3e353](https://github.com/kachnitel/FrdEntityComponentsBundle/commit/b3e35333008606a6df6cc1bd7f8793f13dc4934b))
* Improve test coverage of field components ([9a2650](https://github.com/kachnitel/FrdEntityComponentsBundle/commit/9a26507704f29a85daac31e98645c628abb51ba5))

### Documentation

* Update docs with current components ([7a3337](https://github.com/kachnitel/FrdEntityComponentsBundle/commit/7a3337049f0b8015606fa5b359e066aeb3812096))


---

## [0.0.1](https://github.com/kachnitel/FrdEntityComponentsBundle/compare/0ae260f82d18bfc0de869e8ed4f77444d92a582b...0.0.1) (2026-02-08)
